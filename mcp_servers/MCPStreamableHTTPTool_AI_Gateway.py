    ...
    async with DefaultAzureCredential() as credential:
        async with (
            MCPStreamableHTTPTool(
                ...
                url="https://testgatewayeastus.azure-api.net/tool-sanjeku-eastus-8995-learn-microsoft-com-api-mcp",
            ...
            print("📝 User: How to create an Azure NetApp Files account using az cli?")
            print("🤖 Agent: ", end="", flush=True)
            
            async for chunk in agent.run_stream(
                "How to create an Azure NetApp Files account using az cli?",
                tools=mcp_server
            ):
                if chunk.text:
